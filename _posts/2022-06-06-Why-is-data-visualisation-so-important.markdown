...
In terms of our earlier example problem, a bubble map overlayed onto a map could be a perfect solution. Data visualisation provides a method of data presentation that's expandable, professional looking, and easy to understand. 
...
*This example bubble map shows proportion of dataset by continent  
