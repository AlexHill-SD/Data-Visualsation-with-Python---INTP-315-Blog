...
The bullet points above cover just a few of the advantages to data visualisation, to get a further idea of how data visualisation can provide advantages in todays data driven world this section will take a deeper dive into how these combine to create an end product that's worth learning to master.
...
> ![]({{site.baseurl}}/img/2022-06-06_imgs/bubble_map_covid_bad_example.png)
*Bubble map showing total covid cases by country  
Generated by [everviz.com](https://app.everviz.com)*
...
> ![]({{site.baseurl}}/img/2022-06-06_imgs/bubble_map_covid_bad_example_2.png)
*Bubble map, with tweaked settings, showing total covid cases by country  
Generated by [everviz.com](https://app.everviz.com)*

Now here's an example of the same information but shown in a donut pie chart style, as you can see it is much easier to see which countries have the highest number of cases at a glance, compared to the bubble map.

> ![]({{site.baseurl}}/img/2022-06-06_imgs/bubble_map_covid_bad_example_3.png)
*Donut pie chart showing total covid cases by country  
Generated by [everviz.com](https://app.everviz.com)*
...
> #### Making sure to chose the right type of data visualisation is as important as making sure your data is well structured for the task at hand.
