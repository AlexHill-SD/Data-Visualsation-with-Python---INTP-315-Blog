...
> {% include lightbox.html url="img/2022-06-06_imgs/bubble_map_covid_bad_example_3.png" thumb_width="100%" title="Donut pie chart showing total covid cases by country" lightbox_gallery="photo-1" caption="Donut pie chart showing total covid cases by country  
Generated by [everviz.com](https://app.everviz.com)"%}
