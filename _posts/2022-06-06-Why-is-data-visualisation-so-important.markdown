...
image:  blog_title_imgs/circuit_board_colour_mini-min.jpg
...
> {% include lightbox.html url="img/2022-06-06_imgs/bubble_map_covid_example.png" thumb_width="100%" title="This example bubble map shows proportion of dataset by geographical location" lightbox_gallery="dv_example_images" caption="This example bubble map shows proportion of dataset by geographical location  
...
> {% include lightbox.html url="img/2022-06-06_imgs/bubble_map_covid_example_2.png" thumb_width="100%" title="Bubble map showing total Covid cases by continent" lightbox_gallery="dv_example_images" caption="Bubble map showing total Covid cases by continent  
Generated by [everviz.com](https://app.everviz.com)"%}
...
> {% include lightbox.html url="img/2022-06-06_imgs/dashboard_covid_example.png" thumb_width="100%" title="A sample Covid dashboard by ArcGIS" lightbox_gallery="dv_example_images" caption="A sample Covid dashboard by ArcGIS  
...
> {% include lightbox.html url="img/2022-06-06_imgs/bubble_map_covid_bad_example.png" thumb_width="100%" title="Bubble map showing total Covid cases by country" lightbox_gallery="dv_example_images" caption="Bubble map showing total Covid cases by country  
Generated by [everviz.com](https://app.everviz.com)"%}
...
> {% include lightbox.html url="img/2022-06-06_imgs/bubble_map_covid_bad_example_2.png" thumb_width="100%" title="Bubble map, with tweaked settings, showing total Covid cases by country" lightbox_gallery="dv_example_images" caption="Bubble map, with tweaked settings, showing total Covid cases by country  
Generated by [everviz.com](https://app.everviz.com)"%}
...
> {% include lightbox.html url="img/2022-06-06_imgs/bubble_map_covid_bad_example_3.png" thumb_width="100%" title="Doughnut pie chart showing total Covid cases by country" lightbox_gallery="dv_example_images" caption="Doughnut pie chart showing total Covid cases by country  
Generated by [everviz.com](https://app.everviz.com)"%}

If you were the client, which would you rather look at? It is important to keep in mind that data visualisation is a tool, and like any tool you have to choose the right one for the job. Sometimes data visualisation isn't the best choice, but with the wide range of visualisation types there is nearly always a way to get your data across in a useful and engaging way. If there isn't, then make a dashboard and combine a multitude of visualisations to suit the need at hand.
